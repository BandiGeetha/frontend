     ...
     <NavLink to='/'><img src={assets.logo} className='w-36' alt="Logo" /></NavLink>
      ...
      <div className='flex items-center gap-6'>
        ...
        <div className='group relative'>
         <NavLink to='/login'> <img className='w-5 cursor-pointer' src={assets.profile_icon} alt="Profile" /></NavLink>
      ...
      <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`}>
             <div className='flex flex-col text-grey-600'>
              <div onClick={()=>setVisible(false)} className='flex items-center gap-4 p-3 cursor-pointer'>
                 <img  className='h-4 rotate-180' src={assets.droupdown_icon} alt="" />
                 <p>Back</p>
              </div>
